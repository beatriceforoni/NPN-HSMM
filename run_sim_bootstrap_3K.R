...
save.image("N1000_dPoisson_eMVNorm_3K.RData")
...
####################
save.image("N1000_dPoisson_eMVNorm_3K_boot.RData")
####################
coverage.summary(
  fit = results_list,
...
save.image("N1000_dNegBin_eMVNorm_K3.RData")
...
####################
save.image("N1000_dNegBin_eMVNorm_K3_boot.RData")
####################
coverage.summary(
  fit = results_list,
  boot = results_list.boot,
